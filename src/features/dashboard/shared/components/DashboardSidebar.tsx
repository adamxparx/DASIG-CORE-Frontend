  ...
  TBI_MANAGER: [
    {
      ...
      title: 'Welcome to DASIG-CORE',
      points: [
        "This short tutorial walks you through the main things you can do as a Committee Lead.",
        "Use Next and Back to move through the steps, or Skip to close it at any time.",
        "You can reopen this tutorial anytime from Quick Guide in the sidebar.",
      ],
    },
    {
      label: 'Track KPIs',
      title: 'Track Your Committee’s KPIs',
      points: [
        "The Committee KPI Dashboard lists the KPIs assigned to your committee.",
        "Review each KPI's progress toward its target and deadline at a glance.",
      ],
    },
    {
      label: 'Submit KPI',
      title: 'Submit an Official KPI Entry',
      points: [
        "Open Submit KPI, choose the assigned KPI and reporting period, then enter the value achieved.",
        "If a member has already submitted an internal value for that period, it's pre-filled for you to confirm or adjust.",
        "Your submission is saved as an approved official final contribution for Admin dashboards and reports.",
      ],
    },
    {
      label: 'Review Members',
      title: 'Review Member Submissions',
      points: [
        "Open Submission History to see your committee's full submission log.",
        "Pending member (Staff) submissions can be approved to count as official progress, or returned with feedback for correction.",
      ],
    },
    {
      label: 'Notifications',
      ...
      points: [
        "Open Notifications for deadline reminders and updates on your committee's assigned KPIs.",
      ],
    },
    {
      label: 'Done',
      title: "You're all set",
      points: [
        "That covers the core Committee Lead workflow: tracking assigned KPIs, submitting official entries, and reviewing member submissions.",
        "Reopen this tutorial anytime from Quick Guide in the sidebar.",
      ],
    },
  ],
      ...
      >
        ...
        <DialogContent sx={{ pb: 2 }}>
          ...
          <List sx={{ py: 0, listStyleType: 'disc', pl: 3 }}>
            {currentTutorialStep?.points.map((point) => (
