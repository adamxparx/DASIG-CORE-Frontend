...
const DeactivateUserDialog = ({ open, userId, onClose, onDeactivated }: DeactivateUserDialogProps) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      setErrorMessage(
        err instanceof ApiError ? err.message : 'Unable to deactivate account. Please try again.',
      );
    } finally {
